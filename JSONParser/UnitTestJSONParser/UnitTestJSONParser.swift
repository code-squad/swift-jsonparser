...
class UnitTestJSONParser: XCTestCase {
    ...
    func testJSONParserArrayWithIntsCASE() {
        ...
        XCTAssertEqual(try! parserTest.makeJSONData(testRawJSONData).analyzeData().intTypeCount, 7)
    }
    
    func testJSONParserArrayStringCASE() {
        let parserTest = JSONParser()
        let testRawJSONData = "[ 10, \"jk\", 4, \"314\", 99, \"crong\", false ]"
        XCTAssertEqual(try! parserTest.makeJSONData(testRawJSONData).analyzeData().stringTypeCount, 3)
    }
    
    func testJSONParserArrayBoolCASE() {
        let parserTest = JSONParser()
        let testRawJSONData = "[ 10, \"jk\", 4, \"314\", true, \"crong\", false ]"
        XCTAssertEqual(try! parserTest.makeJSONData(testRawJSONData).analyzeData().boolTypeCount, 2)
    }
    
    func testJSONParserArraySumOfDataCASE() {
        let parserTest = JSONParser()
        let testRawJSONData = "[ 10, \"jk\", 4, \"314\", 99, \"crong\", false ]"
        XCTAssertEqual(try! parserTest.makeJSONData(testRawJSONData).analyzeData().sumOfData, 7)
    }
    ...
    func testJSONParserObjectInArrayCASE1() {
        ...
        XCTAssertEqual(try! parserTest.makeJSONData(testRawJSONData1).analyzeData().objectTypeCount, 2)
    }
    ...
    func testJSONParserObjectInArrayFirstAndEndObjects() {
        ...
        XCTAssertEqual(parserTypeCount.analyzeData().objectTypeCount, 2)
    }
    ...
    func testJSONParserObjectInArrayObjectOfEnd() {
        ...
        let parserTypeCount = try! parser.makeJSONData(testRawJSONData1)
        XCTAssertEqual(parserTypeCount.analyzeData().objectTypeCount, 1)
    }
    ...
    func testMakeJSONDataMethod() {
        ...
        let parserTypeCount = try! parser.makeJSONData(testRawJSONData1)
        XCTAssertEqual(parserTypeCount.analyzeData().arrayTypeCount, 2)
    }
    ...
    func testJSONParserObjectBoolCASE() {
        ...
        XCTAssertEqual(separateValue.analyzeData().boolTypeCount, 2)
    }
    ...
    func testJSONParserObjectStringCASE() {
        ...
        let parserTypeCount = try! parser.makeJSONData(testRawJSONData1)
        XCTAssertEqual(parserTypeCount.analyzeData().stringTypeCount, 2)
    }
    ...
    func testJSONParserObjectIntCASE() {
        ...
        let testRawJSONData1 = "{ \"name\" : \"KIM JUNG\", \"alias\" : \"JK\", \"level\" : 5, \"married\" : true }"
        let parserTypeCount = try! parser.makeJSONData(testRawJSONData1)
        XCTAssertEqual(parserTypeCount.analyzeData().intTypeCount, 1)
    }
    ...
    func testJSONParserObjectSumOfDataCASE() {
        ...
        let testRawJSONData1 = "{ \"name\" : \"KIM JUNG\", \"alias\" : \"JK\", \"level\" : 5, \"married\" : true }"
        let parserTypeCount = try! parser.makeJSONData(testRawJSONData1)
        XCTAssertEqual(parserTypeCount.analyzeData().sumOfData, 4)
    }
    ...
    func testJSONParserArrayMethodBoolCASE() {
        ...
        let testRawJSONData1 = "{ \"name\" : \"KIM JUNG\", \"alias\" : \"JK\", \"level\" : 5, \"married\" : true }"
        let parserTypeCount = try! parser.makeJSONData(testRawJSONData1)
        XCTAssertEqual(parserTypeCount.analyzeData().boolTypeCount, 1)
    }
